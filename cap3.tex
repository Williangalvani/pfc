...
Um exemplo passo-a-passo da execução do algoritmo de Nelder-Mead pode ser visto na figura~\ref{fig:neldermeadsteps}. A partir de um ponto inicial, o simplex se locomove como uma ameba até encontrar um ponto de mínimo.
%
