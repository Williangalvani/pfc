...
\begin{itemize}
\item The ESCs are unable to cope with the 400Hz PWM\foot{Pulse Width Modulation} signal generated by the flight controller;
\item The signal voltage was not high enough;
\end{itemize}

The ESCs did answer properly to a 50Hz signal, so they were working.
%
It was later found in the DiyDrones\ref{diydrones} forum that the ESCs are incompatible with the Pixhawk controller, and two components had to be removed for them to work.
%
...
\caption{ESC antes da modificação.}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figs/escafter.jpg}
  \caption{ESC depois da modificação.}
\end{subfigure}

\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figs/sinalbom.jpg}
  \caption{Sinal antes da modificação.}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{figs/sinalruim.jpg}
  \caption{Sinal depois da modificação.}
\end{subfigure}

\caption{Modificações do ESC.}
